...
exports.GlslMinify = exports.nullDirname = exports.TokenType = exports.TokenMap = void 0;
const glslTypes = [
    // Basic types
...
const isSwizzle = (token) => token.match(/^[rgba]{1,4}$/) !== null
...
(function (TokenType) {
     ...
     */
    TokenType[TokenType["ttReservedToken"] = 1] = "ttReservedToken";
    /** A variable type: int, float, vec2, etc. */
    TokenType[TokenType["ttType"] = 2] = "ttType";
    /** The attribute keyword */
    TokenType[TokenType["ttAttribute"] = 3] = "ttAttribute";
    /** The uniform keyword */
    TokenType[TokenType["ttUniform"] = 4] = "ttUniform";
    /** The varying keyword */
    TokenType[TokenType["ttVarying"] = 5] = "ttVarying";
    /** The layout keyword */
    TokenType[TokenType["ttLayout"] = 6] = "ttLayout";
    /** The in and out keywords */
    TokenType[TokenType["ttInOut"] = 7] = "ttInOut";
    /** An operator, excluding parentheses, dots, braces, brackets, and semicolons */
    TokenType[TokenType["ttOperator"] = 8] = "ttOperator";
    /** ( */
    TokenType[TokenType["ttOpenParenthesis"] = 9] = "ttOpenParenthesis";
    /** ) */
    TokenType[TokenType["ttCloseParenthesis"] = 10] = "ttCloseParenthesis";
    /** { */
    TokenType[TokenType["ttOpenBrace"] = 11] = "ttOpenBrace";
    /** } */
    TokenType[TokenType["ttCloseBrace"] = 12] = "ttCloseBrace";
    /** [ */
    TokenType[TokenType["ttOpenBracket"] = 13] = "ttOpenBracket";
    /** ] */
    TokenType[TokenType["ttCloseBracket"] = 14] = "ttCloseBracket";
    /** A semicolon */
    TokenType[TokenType["ttSemicolon"] = 15] = "ttSemicolon";
    /** The dot operator. This operator has special meaning in GLSL due to vector swizzle masks. */
    TokenType[TokenType["ttDot"] = 16] = "ttDot";
    /** A numeric value */
    TokenType[TokenType["ttNumeric"] = 17] = "ttNumeric";
    /** A GLSL preprocessor directive */
    TokenType[TokenType["ttPreprocessor"] = 18] = "ttPreprocessor";
    /** Special value used in the parser when there is no token */
    TokenType[TokenType["ttNone"] = 19] = "ttNone";
...
exports.nullDirname = nullDirname;
...
class GlslMinify {
    ...
    executeFile(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let sourceCode = yield this.processIncludes(input);
    ...
    processIncludes(content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (true) {
                ...
                const includeContent = yield this.processIncludes(includeFile);
            ...
            switch (type) {
                case TokenType.ttPreprocessor: {
                    ...
                    if (subMatch) {
                        ...
                        if (((_a = subMatch[2]) === null || _a === void 0 ? void 0 : _a[0]) === '(') { // This is a function
